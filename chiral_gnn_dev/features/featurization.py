...
class MolGraph:
    ...
    def __init__(self, smiles: str, args: Namespace):
        ...
        self.f_bonds = []  # mapping from bond index to features
        ...
        for a1 in range(self.n_atoms):
            for a2 in range(a1 + 1, self.n_atoms):
                ...
                self.f_bonds.append(f_bond) # append twice, atom feature only append once
                self.f_bonds.append(f_bond) # note. chemprop concat atom_feature here, but this one is not !

                # Update index mappings
                b1 = self.n_bonds
                b2 = b1 + 1
                # a2b => 2d list, adjacency list
